...
module.exports = class lessonPlansDB extends DB {
  constructor(data){
    super("lessonplans", ["id","uid","img","subject","grade","topic","description","instruction","isPublic","isDraft","createdTime","learningObjs","remarks"]);
    this.data = data;
    this.returns = ["*"];
    this.config = {};
  }
